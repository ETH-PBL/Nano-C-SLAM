...
uint8_t RdByte(uint8_t *dev_addr, uint16_t index, uint8_t *pdata) {
    int8_t status = 0;
...
uint8_t WrByte(uint8_t *dev_addr, uint16_t index, uint8_t data) {
    int8_t status = 0;
...
uint8_t RdMulti(uint8_t *dev_addr, uint16_t index, uint8_t *pdata,
                uint32_t count) {
    int8_t status = 0;
...
uint8_t WrMulti(uint8_t *dev_addr, uint16_t index, uint8_t *pdata,
                uint32_t count) {
    int8_t status = 0;
