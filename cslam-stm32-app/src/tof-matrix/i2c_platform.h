...
uint8_t RdByte(uint8_t *dev, uint16_t RegisterAdress, uint8_t *p_value);
...
uint8_t WrByte(uint8_t *dev, uint16_t RegisterAdress, uint8_t value);
...
uint8_t RdMulti(uint8_t *dev, uint16_t RegisterAdress, uint8_t *p_values,
                uint32_t size);
...
uint8_t WrMulti(uint8_t *dev, uint16_t RegisterAdress, uint8_t *p_values,
                uint32_t size);
...
uint8_t Reset_Sensor(uint8_t dev);
